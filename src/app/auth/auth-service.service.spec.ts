...
describe('AuthServiceService', () => {
  ...
  let oauthService = new OAuthService(null,null,null,null,null,null,null,null,null);
  ...
  it('Should login', () => {
    try {
      jest.spyOn(oauthService, "loadDiscoveryDocumentAndLogin").mockImplementation(() => {
